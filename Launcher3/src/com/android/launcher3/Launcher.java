...
import static com.android.launcher3.popup.SystemShortcut.REMOVE_FROM_HOTSEAT;
...
public class Launcher extends StatefulActivity<LauncherState>
                ...
                if (requestArgs.container == CONTAINER_DESKTOP) {
                    ...
                    requestArgs.screenId = getCellPosMapper().mapPresenterToModel(
                            presenterPos.cellX, presenterPos.cellY, newScreenId, CONTAINER_DESKTOP)
                                    .screenId;
                    // Re-derive presenterPos after screenId may have changed.
                    presenterPos = getCellPosMapper().mapModelToPresenter(requestArgs);
                }
                final CellLayout dropLayout =
                        mWorkspace.getScreenWithId(presenterPos.screenId);

                if (dropLayout == null) {
                    // Screen no longer exists (e.g. launcher was killed during config activity).
    ...
    protected void onDeferredResumed() {
        ...
        // Request rebind in case the service was disconnected after being previously granted.
        // This is a no-op if already connected or if permission was never granted.
    ...
    void completeAddAppWidget(int appWidgetId, ItemInfo itemInfo,
        ...
        if (appWidgetInfo == null) {
            Log.w(TAG, "completeAddAppWidget: widget info unavailable for id=" + appWidgetId);
            mAppWidgetHolder.deleteAppWidgetId(appWidgetId);
            return;
        }
    ...
    public void bindComplete(int workspaceItemCount, boolean isBindSync) {
        ...
        if (mHotseat != null) {
            mHotseat.post(() -> mHotseat.updateHotseatIconScale());
        }
    }
    ...
    public TouchController[] createTouchControllers() {
        return new TouchController[] {getDragController(), new AllAppsSwipeController(this),
                new com.android.launcher3.touch.StatusBarSwipeController(this)};
    }
    ...
    public Stream<SystemShortcut.Factory> getSupportedShortcuts() {
        return Stream.of(APP_INFO, WIDGETS, INSTALL, REMOVE_FROM_HOTSEAT);
    }
